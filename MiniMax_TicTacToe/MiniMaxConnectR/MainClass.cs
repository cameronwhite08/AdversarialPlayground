    ...
    class MainClass
    {
        ...
        public static void HumanVsComputer()
        {
            ...
            while (column != -1)
            {
                ...
                //make pc move
                var aiMove = AI(board, index.Item1, index.Item2, Player, 6);
                index = DropPiece(board, aiMove, Computer);
        ...
        static int AI(sbyte[][] board, int row, int column, sbyte piece, int depth)
        {
            ...
            return tree.Children[index].UpdatedColumn;
        }
        #endregion
    }
